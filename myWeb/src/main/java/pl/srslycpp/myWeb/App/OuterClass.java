  ...
  public class OuterClass {
        private final int outerClassInstanceVariable =54;
            ...
            public void exampleMethod() {
                ...
                // MethodLocalInnerClass can be instantiated only in this method exampleMethod()
                // outside MethodLocalInnerClass
        ...
        public class InnerClass {
            ...
            public void privateVariablesOfOuterClassAreAvailable() {
                System.out.println(outerClassInstanceVariable); // we can access the value and
                // change it
