...
public class IngredientControllerTest {
    ...
    public void testShowIngredient() throws Exception {
        ...
        //then
        mockMvc.perform(get("/projects/recipe/1/ingredient/2/show"))
                .andExpect(status().isOk())
    ...
    public void testNewIngredientForm() throws Exception {
        ...
        //then
        mockMvc.perform(get("/projects/recipe/1/ingredient/new"))
                .andExpect(status().isOk())
    ...
    public void testUpdateIngredientForm() throws Exception {
        ...
        //then
        mockMvc.perform(get("/projects/recipe/1/ingredient/2/update"))
                .andExpect(status().isOk())
                .andExpect(view().name("recipe/ingredients/ingredientform"))
                .andExpect(model().attributeExists("ingredient"))
                .andExpect(model().attributeExists("uomList"));
    ...
    public void testSaveOrUpdate() throws Exception {
        ...
        mockMvc.perform(post("/recipe/2/ingredient")
                ...
                .andExpect(view().name("redirect:/projects/recipe/2/ingredients/3/showIngredient"));
    ...
    public void testDeleteIngredient() throws Exception {
        ...
        //then
        mockMvc.perform(get("/projects/recipe/2/ingredient/3/delete")
        )
                .andExpect(status().is3xxRedirection())
                .andExpect(view().name("redirect:/projects/recipe/2/listOfIngredients"));
